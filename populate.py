...
def seedPlanting(db):
    ...
    db.session.add(Plantings(name='Alface', planting_date='2019-10-11 09:30:03.478039', sprouted_seedlings=0, current_humidity=28, current_temperature=23, hours_backlit=2, cycle_finished=False, picture_url='https://planetahuerto-6f4f.kxcdn.com/estaticos/imagenes/articulo_revista/154/154_620x465.jpg', machine=machine, seedling=seedling))
    db.session.commit()
